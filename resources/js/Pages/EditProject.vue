...
const props = defineProps(['title','project']);
...
onMounted(() => {
    ...
    form.demo = props.project.demo
    form.git = props.project.git
    form.short = props.project.short
        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                    ...
                    <div class="text-gray-900 text-xl mb-2">Edit Project</div>
                    <form @submit.prevent="form.put(route('project.update', project.id))">
                        <div>
